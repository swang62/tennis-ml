...
SELECT
    ...
    p.win_rate_5, p.win_rate_10, p.win_rate_20,
    p.ace_rate_5, p.ace_rate_10,
    p.first_serve_pct_5, p.first_serve_pct_10,
    p.break_pct_5, p.break_pct_10,
    p.avg_opp_rank_10, p.avg_opp_rank_20,
    p.rank_trend_10, p.rank_trend_20,
    p.win_streak, p.days_since_last_match, p.matches_30d, p.surface_win_rate_10,

    -- Opponent side
    o.player_ranking AS opponent_ranking,
    o.wins_last_10 AS opp_wins_last_10, o.matches_last_10 AS opp_matches_last_10,
    o.aces AS opp_aces, o.double_faults AS opp_double_faults,
    o.first_serves_made AS opp_first_serves_made, o.total_serve_points AS opp_total_serve_points,
    o.break_points_won AS opp_break_points_won, o.break_points_total AS opp_break_points_total,
    o.win_rate_last_10 AS opp_win_rate_last_10, o.ace_rate AS opp_ace_rate,
    o.double_fault_rate AS opp_double_fault_rate,
    o.first_serve_pct AS opp_first_serve_pct,
    o.break_points_converted_pct AS opp_break_points_converted_pct,
    o.win_rate_5 AS opp_win_rate_5, o.win_rate_10 AS opp_win_rate_10,
    o.win_rate_20 AS opp_win_rate_20,
    o.ace_rate_5 AS opp_ace_rate_5, o.ace_rate_10 AS opp_ace_rate_10,
    o.first_serve_pct_5 AS opp_first_serve_pct_5, o.first_serve_pct_10 AS opp_first_serve_pct_10,
    o.break_pct_5 AS opp_break_pct_5, o.break_pct_10 AS opp_break_pct_10,
    o.avg_opp_rank_10 AS opp_avg_opp_rank_10, o.avg_opp_rank_20 AS opp_avg_opp_rank_20,
    o.rank_trend_10 AS opp_rank_trend_10, o.rank_trend_20 AS opp_rank_trend_20,
    o.win_streak AS opp_win_streak,
    o.days_since_last_match AS opp_days_since_last_match,
    o.matches_30d AS opp_matches_30d,
    o.surface_win_rate_10 AS opp_surface_win_rate_10,
    ...
    p.break_pct_10 - o.break_pct_10 AS break_diff,
    CAST(p.win_streak AS INTEGER) - CAST(o.win_streak AS INTEGER) AS streak_diff,
    CAST(p.matches_30d AS INTEGER) - CAST(o.matches_30d AS INTEGER) AS matches_30d_diff,
    p.surface_win_rate_10 - o.surface_win_rate_10 AS surface_win_diff,

...
def _load_cluster_labels() -> dict[str, str]:
    ...
    The cluster-assignment parquet and description JSON are generated by the
    pipeline (build_cluster_artifacts in src.models.similarity) after each
    snapshot refresh. Absent artifacts (e.g. before the first clustering run)
    yield an empty map so the directory never breaks.
    """

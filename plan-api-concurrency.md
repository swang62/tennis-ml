...
### [ ] 1. Replace the process-global connection with a bounded Psycopg pool
...
- **Sizing:** `min_size=1`, `max_size=4` per Bento worker, so four Bento workers allow up to 16 concurrent PostgreSQL queries; document the PostgreSQL connection-capacity requirement.
...
### [ ] 2. Delete obsolete directory endpoints
...
### [ ] 3. Verify concurrency contracts and frontend behavior
